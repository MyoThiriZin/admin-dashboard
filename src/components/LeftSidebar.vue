  ...
  <div class="vertical-menu">
    ...
    <div class="navbar-brand-box">
      <a href="index.html" class="logo logo-dark">
        <span class="logo-sm">
          <img
            :src="require('../../public/assets/images/logo-sm.png')"
            alt=""
            height="22"
          />
        </span>
        <span class="logo-lg">
          <img
            :src="require('../../public/assets/images/logo-dark.png')"
            alt=""
            height="20"
          />
        </span>
      ...
      <a href="index.html" class="logo logo-light">
        ...
        <span class="logo-lg">
          <img
            :src="require('../../public/assets/images/logo-light.png')"
            alt=""
            height="20"
          />
        </span>
...
export default {
  ...
  methods: {
    initMetisMenu() {
      // Assuming you have imported the "metisMenu" library
      const sideMenu = new MetisMenu(this.$refs.sideMenu);
      sideMenu.init();
    },
    // initActiveMenu() {
    //   const pageUrl = window.location.href.split(/[?#]/)[0];
    //   const menuItems = this.$refs.sidebarMenu.getElementsByTagName("a");
    //   for (let i = 0; i < menuItems.length; i++) {
    //     const menuItem = menuItems[i];
    //     if (menuItem.href === pageUrl) {
    //       menuItem.classList.add("active");
    //       menuItem.parentElement.classList.add("mm-active");
    //       menuItem.parentElement.parentElement.classList.add("mm-show");
    //       menuItem.parentElement.parentElement.previousElementSibling.classList.add(
    //         "mm-active"
    //       );
    //       menuItem.parentElement.parentElement.parentElement.classList.add(
    //         "mm-active"
    //       );
    //       menuItem.parentElement.parentElement.parentElement.parentElement.classList.add(
    //         "mm-show"
    //       );
    //       menuItem.parentElement.parentElement.parentElement.parentElement.parentElement.classList.add(
    //         "mm-active"
    //       );
    //     }
    //   }
